...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="estilos/mis_estilos.css">
                ...
                <div class="login-container">
                    <div class="register">
                        ...
                        <form method="post" action="usuario.do">
                            ...
                            <label>Nombre y Apellido:<input class="box" type="text" name="nombre" maxlength="50" style="color:#ffffff" required></label>
                            <label>Correo:<input class="box"  type="email" name="correo" maxlength="50" style="color:#ffffff" required></label>
                            ...
                            <label>Telefono:<input class="box" type="text" name="telefono" maxlength="50" style="color:#ffffff" required></label>
